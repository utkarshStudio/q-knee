...
export function ProtectedRoute({ children, requiredRole }: { children: ReactNode; requiredRole?: string }) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen bg-graphite-950">
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-graphite-950 flex items-center justify-center p-6 text-center">
        <div className="max-w-md w-full p-8 rounded-2xl bg-graphite-900/70 border border-graphite-800 shadow-2xl backdrop-blur-md">
          ...
          <h2 className="text-xl font-bold text-white mb-2">Sign in required for this feature</h2>
          <p className="text-graphite-400 text-sm mb-6 leading-relaxed">
